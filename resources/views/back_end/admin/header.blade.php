        ...
        <div class="navbar-header" data-logobg="skin5">
            <a class="navbar-brand" href="index.html">
                <b class="logo-icon ps-2">
                    <img src="{{asset('back-end/assets/images/logo-icon.png')}}" alt="homepage" class="light-logo" />

                </b>
                <span class="logo-text">
                            <img src="{{asset('back-end/assets/images/logo-text.png')}}" alt="homepage" class="light-logo" />
